...
namespace transport_catalogue { 
    ...
    std::vector<std::pair<int, std::string>> TransportCatalogue::ParseStopDistances(const std::string& input) const {
        return transport_catalogue::ParseStopDistances(input);
    }
